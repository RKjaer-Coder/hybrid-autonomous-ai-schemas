...
def model_efficiency_customer_validation_brief(
    ...
    *,
    ...
    payload = model_efficiency_customer_validation_brief_packet(
        ...
        generated_at=timestamp,
        artifact_path=_runtime_model_efficiency_customer_validation_brief_path(resolved),
    )
...
def _model_efficiency_customer_validation_brief_contract(
    ...
    return model_efficiency_customer_validation_brief_contract(
        brief,
        service_packet,
...
def _target_machine_runtime_proof_builder_inventory() -> dict[str, Any]:
    builders = [
        ...
        },
        {
            ...
            "status": "service_owned_this_slice",
            "next_action": "preserve local-only customer-validation brief/checker coverage",
        },
        {
...
def target_machine_validation_run_packet(
    ...
    *,
    ...
    replay_projection_proof_contract = target_machine_replay_projection_proof_contract(
    ...
    replay_projection_proof_records = target_machine_replay_projection_proof_records()
    replay_projection_proof_records_contract = target_machine_replay_projection_proof_records_contract(
        replay_projection_proof_records
    )
    ...
    if runtime_proof_builder_inventory["next_service_slice"] != "none_ready":
        blockers.append("runtime_proof_builder_inventory_missing_completion_marker")
